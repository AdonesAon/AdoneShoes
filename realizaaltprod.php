<!DOCTYPE html>
<html lang="pt-BR">
<head><title>Alteração do Produto</title>
        ...
        <div class="totalcolumn">
			...
			<div class="page">
                ...
                <?php		
                        ...
                        $valor=$_POST["valor"];  
                        $data=$_POST["data"];
                        $sql="UPDATE produto SET id='$id',nome='$nome',cnpj='$cnpj',tel='$tel',email='$email',nome_prod='$nome_prod',quant='$quant',valor='$valor',data='$data' WHERE id='$id' ";
                    ...
                    <div class="page">
						...
						<div class="alertyellow">Produto alterado com sucesso!</div><p>
