<!DOCTYPE html>
<html lang="pt-BR">
<head><title>Lista de Clientes</title>
        ...
        <div class="totalcolumn">
			...
			<div class="page">
				...
				<?php $con=mysqli_connect("localhost","root","","calcados"); 
					...
					$result = mysqli_query($con,"SELECT * FROM cliente");?><p>
					<h2>Clientes Cadastrados</h2>
						<table>	
							...
							<tr>	
								...
								<td><form action="realizadelclient.php" method="post">					 
									<input type="hidden" name="id" value="<?php echo $row["id"]; ?>"/>			 
									<button type="submit" name="botdelclient" value="ok" class="btn1">Deletar</button>		         
									</form></td>
								<td><form action="formaltclient.php" method="post">				            
									<input type="hidden" name="id" value="<?php echo $row["id"]; ?>"/>		            
									<button type="submit" name="botaltclient" value="ok" class="btn2">Alterar</button>		         
									</form></td>
							</tr>
							<?php } 	
								mysqli_close($con);
