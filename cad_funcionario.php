<!DOCTYPE html>
<html lang="pt-BR">
<head><title>Cadastro de Funcionário</title>
        ...
        <div class="totalcolumn">
            ...
            <div class="totalcolumn">
                ...
                <?php
					...
					$sexo=$_POST["sexo"];
					$dn=$_POST["dn"];
					$sql="insert into funcionario(nome,cpf,tel,email,ende,sexo,dn)
					values('$nome','$cpf','$tel','$email','$ende','$sexo','$dn')";
				...
				<div class="page">
					<div class="alertgreen">Funcionário cadastrado com sucesso!</div><p>
