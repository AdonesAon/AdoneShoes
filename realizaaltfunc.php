<!DOCTYPE html>
<html lang="pt-BR">
<head><title>Alteração de Funcionário</title>
        ...
        <div class="totalcolumn">
			...
			<div class="page">
                ...
                <?php		
                        ...
                        $sexo=$_POST["sexo"];
                        $dn=$_POST["dn"];  
                        $sql="UPDATE funcionario SET id='$id',nome='$nome',cpf='$cpf',tel='$tel',email='$email',ende='$ende',sexo='$sexo',dn='$dn' WHERE id='$id' ";
                    ...
                    <div class="page">
						...
						<div class="alertyellow">Funcionário alterado com sucesso!</div><p>

						<div class="button1"><a href="index.html">Página Inicial</a></div>
					
						<div class="button1"><a href="listar_funcionario.php">Ir para Lista</a></div>
					</div>
