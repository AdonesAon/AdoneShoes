<!DOCTYPE html>
<html lang="pt-BR">
<head><title>Alterar Cliente</title>
        ...
        <div class="totalcolumn">
            ...
            <div class="caixa1">
                ...
                <div class="page">
                    ...
                    <form action="realizaaltclient.php" method="POST" class="formDados">
                        <?php 
                            while($row = mysqli_fetch_array($result))  {
                        ?>	
                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>"/>	
                        <div class="flex-container">
                            <a href="listar_cliente.php"><img src="imagem/voltar.png"></button></a>
                        </div>
                        <div class="titulo">Alterar Cliente</div> <p>
                        ...
                        <input type="email" name="email" placeholder="Digite seu e-mail" maxlength="200" required value="<?php echo $row['email']; ?>" /></label>
						...
						<input type="text" name="cep" placeholder="00.000-000" maxlength="10" autocomplete="off" required value="<?php echo $row['cep']; ?>" /></label>
